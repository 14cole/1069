...
class SolverTab(QWidget):
    ...
    def _build_left_panel(self) -> QWidget:
        ...
        self.cmb_pol.addItem("TE (vertical / VV)", userData="TM")
        self.cmb_pol.addItem("TM (horizontal / HH)", userData="TE")
    ...
    def _on_solver_finished(self, result: Dict[str, Any], source_path: str):
        ...
        pol = str(result.get("solver_polarization_internal", self.cmb_pol.currentData() or "TM"))
        write_summary = (
